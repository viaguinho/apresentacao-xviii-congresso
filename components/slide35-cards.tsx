    ...
    >
      ...
      >
        ...
        <div className="grid grid-cols-2 gap-2 my-2.5">
          <div className="p-2.5 rounded-xl bg-[#f8f9fa] border border-black/[0.04] flex flex-col justify-between">
            <div>
              <div className="flex items-center gap-1.5 text-[16px] font-bold text-[#0f1012] mb-1">
          ...
          <div className="p-2.5 rounded-xl bg-[#f8f9fa] border border-black/[0.04] flex flex-col justify-between">
            ...
            <span className="text-[16px] text-amber-700 font-semibold mt-1 block">Resposta adaptativa à queixa.</span>
          </div>
        </div>
      ...
      >
        ...
        <div className="relative z-10">
          <div className="flex items-center justify-between mb-1.5">
            <span className="text-[14px] font-bold uppercase tracking-[0.2em] text-red-300 font-['Urbanist',sans-serif]">
              Segurança &amp; Triagem Crítica
            </span>
            <span className="text-[14px] font-semibold text-red-200 bg-red-900/30 px-2.5 py-0.5 rounded-full border border-red-500/40">
              Avaliação Imediata
            </span>
          </div>
        ...
        <div className="flex items-center justify-between pt-2 border-t border-zinc-800 relative z-10">
          ...
          <span className="text-[16px] font-bold text-red-300 bg-red-500/15 px-2.5 py-0.5 rounded-full border border-red-500/30">
