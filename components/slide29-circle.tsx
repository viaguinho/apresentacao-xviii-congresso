...
const POSITIONS = [
  ...
  },
  {
    ...
    startX: 450,
    startY: -250,
    title: "percepção do paciente",
    desc: "satisfação, significado, expectativa",
    icon: Smile,
    color: "#8b5cf6",
  ...
  },
  {
    ...
    startX: 0,
    startY: 360,
    title: "resposta do ambiente",
    desc: "comentários, aceitação, estigma",
    icon: Users,
    color: "#d97706",
    ...
    >
      ...
      <div className="z-30 relative flex items-center justify-center">
        ...
        >
          ...
          {/* Central Typography */}
          <span className="font-['Urbanist',sans-serif] text-[15px] font-bold tracking-tight text-[#0f1012] leading-tight text-center px-2">
            experiência vivida
          </span>
                    ...
                    <div className="flex flex-col text-left overflow-hidden">
                      <div className="flex items-center gap-1.5">
                        <span
                          ...
                          className="font-['Satoshi',sans-serif] text-[17px] font-bold tracking-tight capitalize"
                        >
                          {item.title}
                        </span>
                      </div>
