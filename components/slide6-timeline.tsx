  ...
  const stepsData: TimelineEntry[] = [
    {
      ...
      detail: (
        <div className="flex items-center gap-2 flex-wrap">
          <span className="inline-flex items-center gap-1 text-[13px] font-semibold text-[#0071e3] bg-blue-50/80 px-2.5 py-1 rounded-md border border-blue-200/60">
            <span className="w-1.5 h-1.5 rounded-full bg-[#0071e3]"></span>
            Onda 1: ~8 anos
          </span>
          <span className="text-[#868788] text-xs font-bold">→</span>
          <span className="inline-flex items-center gap-1 text-[13px] font-semibold text-[#0071e3] bg-blue-50/80 px-2.5 py-1 rounded-md border border-blue-200/60">
            <span className="w-1.5 h-1.5 rounded-full bg-[#0071e3]"></span>
            Onda 2: ~10 anos
          </span>
    ...
    },
    {
      ...
      detail: (
        <div className="flex flex-col gap-1.5 w-full">
          <div className="flex items-center gap-2 text-[13px] text-[#3f4042]">
            <span className="font-semibold text-[#e11d48] bg-rose-50 px-2 py-0.5 rounded border border-rose-200 text-xs">
              Comportamental
            </span>
            <span>Duração do som aversivo (*noise blast*) contra o avaliador</span>
          </div>
          <div className="flex items-center gap-2 text-[13px] text-[#3f4042]">
            <span className="font-semibold text-[#0071e3] bg-blue-50 px-2 py-0.5 rounded border border-blue-200 text-xs">
              Neural (fMRI)
            </span>
      ...
      detail: (
        <div className="grid grid-cols-2 gap-2 w-full">
          <div className="bg-slate-50/90 rounded-lg p-2 border border-slate-200/60">
            <div className="text-[11px] uppercase tracking-wider font-bold text-[#0071e3]">Efeitos Fixos</div>
            <div className="text-[13px] font-medium text-[#0f1012] leading-tight mt-0.5">Trajetória média da população</div>
          </div>
          <div className="bg-slate-50/90 rounded-lg p-2 border border-slate-200/60">
            <div className="text-[11px] uppercase tracking-wider font-bold text-[#0071e3]">Efeitos Aleatórios</div>
            <div className="text-[13px] font-medium text-[#0f1012] leading-tight mt-0.5">Variação individual na inclinação</div>
          </div>
        </div>
      ),
    },
