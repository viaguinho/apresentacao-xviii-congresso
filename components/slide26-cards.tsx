            ...
            <div className="grid grid-cols-2 gap-2.5 pt-0.5">
              <div className="p-2.5 rounded-2xl bg-rose-50/80 border border-rose-200/70 text-left">
                <div className="flex items-center gap-1 text-rose-700 mb-0.5">
                  ...
                  <span className="text-[10px] font-bold uppercase tracking-wider">Bullying / Teasing</span>
                </div>
                <p className="text-[11.5px] font-semibold text-rose-900 leading-snug">
              ...
              <div className="p-2.5 rounded-2xl bg-emerald-50/80 border border-emerald-200/70 text-left">
                <div className="flex items-center gap-1 text-emerald-700 mb-0.5">
                  ...
                  <span className="text-[10px] font-bold uppercase tracking-wider">Ter um Bom Amigo</span>
                </div>
                <p className="text-[11.5px] font-semibold text-emerald-900 leading-snug">
