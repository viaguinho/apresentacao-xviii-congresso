...
function QualitativeTooltip({ active, payload, label }: any) {
  ...
  return (
    <div className="bg-white/98 backdrop-blur-md border border-black/10 shadow-xl rounded-2xl p-3.5 max-w-[340px] font-['Satoshi',sans-serif] text-[14px]">
      <p className="font-['Urbanist',sans-serif] font-bold text-[16px] text-zinc-900 mb-1 border-b border-black/[0.06] pb-1">
        {label}
      </p>
      <p className="text-zinc-600 text-[14px] mb-2.5 leading-snug font-medium">
        {currentItem?.detail}
      </p>
  ...
  return (
    <div className="w-full h-full flex flex-col justify-between font-['Satoshi',sans-serif]">
      ...
      <div className="flex flex-wrap items-start justify-between gap-3 mb-3">
        <div>
          <div className="flex items-center gap-2 mb-1">
            <span className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full text-[14px] font-bold uppercase tracking-wide bg-[#b5563a]/15 text-[#8c3e27] border border-[#b5563a]/30">
          ...
          <h3 className="text-[25px] font-bold tracking-tight text-zinc-900 font-['Urbanist',sans-serif] leading-tight">
            Transição da Dependência Regulamentar
          </h3>
          <p className="text-[17px] font-medium text-zinc-600 mt-0.5">
        ...
        <div className="hidden sm:flex items-center gap-2 px-3 py-1.5 rounded-xl bg-[#fdf6f3] border border-[#b5563a]/25 shadow-xs">
          ...
          <span className="text-[15px] font-bold text-[#8c3e27]">
      ...
      <ChartContainer config={chartConfig} className="w-full h-[270px] lg:h-[290px] aspect-auto">
        <LineChart
          data={data}
          margin={{ top: 14, right: 76, left: 0, bottom: 6 }}
        >
          <CartesianGrid
            strokeDasharray="3 3"
            vertical={false}
          ...
          <XAxis
            ...
            tickMargin={10}
            tick={{ fill: '#52525b', fontSize: 15, fontWeight: 600 }}
          />
          <YAxis
            tickLine={false}
            axisLine={false}
      ...
      <div className="flex flex-wrap items-center justify-center gap-x-7 gap-y-1 pt-3 mt-1 border-t border-black/[0.05] text-[16px] font-medium">
