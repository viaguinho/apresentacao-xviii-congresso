...
export default function Slide28Cards({
  ...
  return (
    <div className={cn("w-full flex justify-center select-none font-['Satoshi',sans-serif]", className)}>
      <div className="w-full max-w-[1440px] flex flex-row items-stretch gap-4">
        {/* =========================================================================
        ...
        >
          ...
          {/* -----------------------------------------------------------------------
              ...
              ----------------------------------------------------------------------- */}
          <div className="flex-1 min-w-0 p-4 flex flex-col justify-between relative z-10">
            <div>
              ...
              <div className="flex items-center justify-between gap-2 mb-2">
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-[10px] font-bold uppercase tracking-[0.14em] text-zinc-400 font-['Urbanist',sans-serif]">
                    Audição & Fala
                  </span>
                </div>
                <span className="text-[9.5px] font-semibold text-[#e8909c] bg-[#8a2f3f]/20 px-2.5 py-0.5 rounded-full border border-[#8a2f3f]/30 shrink-0">
                  Amostra 5–13a
                </span>
              </div>

              {/* Título Principal */}
              <h4 className="text-[15px] font-bold tracking-tight text-white font-['Urbanist',sans-serif] leading-tight">
              ...
              <div className="mt-2.5 p-2.5 rounded-xl bg-zinc-900/90 border border-zinc-800/90 flex items-center gap-3">
                <div className="flex flex-col shrink-0">
                  ...
                  <span className="text-[9px] uppercase font-bold text-zinc-500 tracking-wider mt-0.5">
                    das orelhas
                  </span>
                </div>
            ...
            {/* Rodapé da Seção */}
            <div className="pt-2 mt-3 border-t border-zinc-800/80 flex items-center justify-between text-[10.5px]">
              <span className="font-medium text-zinc-400">
                Ressalva clínica:
              </span>
              <span className="font-bold text-[#e8909c] bg-[#8a2f3f]/15 px-2.5 py-0.5 rounded-full border border-[#8a2f3f]/30 text-[9.5px]">
                Amostra ≠ Universal
              </span>
            </div>
          </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-2 mt-2">
                <div className="p-2 rounded-xl bg-zinc-900/90 border border-zinc-800/90 flex flex-col justify-between">
                  ...
                  <p className="text-[10.5px] text-zinc-300 font-medium leading-tight mt-1">
                ...
                <div className="p-2 rounded-xl bg-[#8a2f3f]/10 border border-[#8a2f3f]/30 flex flex-col justify-between">
                  <span className="text-[9px] font-bold uppercase tracking-wider text-[#e8909c]">
                    Ganhos
                  </span>
                  <p className="text-[10.5px] text-zinc-200 font-medium leading-tight mt-1">
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <div className="flex items-center justify-between gap-2 mb-2">
              ...
              <span className="text-[9.5px] font-bold text-[#e8909c] bg-[#8a2f3f]/20 px-2.5 py-0.5 rounded-full border border-[#8a2f3f]/35 uppercase tracking-wider shrink-0">
                O Timing Importa
              </span>
            </div>

            {/* 1. Frase Principal de Timing */}
            <p className="text-[13.5px] text-white font-medium leading-snug mt-2">
          ...
          <div className="pt-2 mt-3 border-t border-[#8a2f3f]/25 flex items-center justify-between text-[10.5px] relative z-10">
            <span className="font-medium text-zinc-400">
