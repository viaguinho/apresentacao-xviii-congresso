      ...
      >
        ...
        <div className="relative z-10">
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="text-[10px] font-semibold text-teal-200 bg-[#0d6d66]/30 px-2 py-0.5 rounded-full border border-teal-500/30">
              Eixo 2 · Cognição
            </span>
          </div>
        ...
        <div className="grid grid-cols-3 gap-2 my-2.5 relative z-10">
          <div className="p-2.5 bg-zinc-900/90 rounded-2xl border border-zinc-800/80 flex flex-col justify-between">
            <div className="flex items-center gap-1.5 mb-1">
              <Mic className="w-3.5 h-3.5 text-cyan-400 shrink-0" />
              <span className="text-[10px] font-bold uppercase tracking-wider text-zinc-400">Fala</span>
            </div>
            <p className="text-[11.5px] text-zinc-200 leading-snug font-medium">Articulação &amp; Fonação mecânica</p>
          </div>

          <div className="p-2.5 rounded-2xl border border-teal-500/30 bg-teal-950/20 flex flex-col justify-between">
            <div className="flex items-center gap-1.5 mb-1">
              <MessageSquare className="w-3.5 h-3.5 text-teal-400 shrink-0" />
              <span className="text-[10px] font-bold uppercase tracking-wider text-teal-300">Linguagem</span>
            </div>
            <p className="text-[11.5px] text-teal-100 leading-snug font-medium">Sistema Simbólico &amp; Semântica</p>
          </div>

          <div className="p-2.5 rounded-2xl border border-emerald-500/30 bg-emerald-950/20 flex flex-col justify-between">
            <div className="flex items-center gap-1.5 mb-1">
              <Brain className="w-3.5 h-3.5 text-emerald-400 shrink-0" />
              <span className="text-[10px] font-bold uppercase tracking-wider text-emerald-300">Inteligência</span>
            </div>
            <p className="text-[11.5px] text-emerald-100 leading-snug font-medium">Potencial &amp; Funções Executivas</p>
          </div>
        </div>

        <div className="relative z-10">
          <p className="text-[11.5px] text-zinc-300 leading-relaxed font-normal mb-2.5">
