...
4. Todas as figuras científicas, esquemas e gráficos de artigos citados estão liberados para utilização e reprodução direta ou adaptada na apresentação, com a devida citação da fonte.
...
| 8 | Campo de forças → encontro com o outro | Eixo 1 | Curvas (Fig. 2–3 Kärtner&Köster) | Future Blue | 🆕 Criar |
...
**Status:** Os 6 logotipos foram baixados e salvos localmente em `assets/logos-conflitos/`, normalizados com fundo transparente e tom grafite monocromático (`#3f4042`), já integrados na grade 3×2 com entrada suave em bloco (`data-anim="fade"`).
...
- [ ] Incluir atribuição das fontes no rodapé dos slides (ex.: Figuras 2–3 Kärtner & Köster nos Slides 8–9).
...
│   └── figuras-cientificas/                  # Ilustrações e gráficos dos artigos (Slides 8–9 etc.), com atribuição da fonte
└── uploads/
...
- [ ] Atribuição de fontes/artigos incluída adequadamente nos rodapés.
...
3. **Estilo visual das Figuras Kärtner & Köster (2024):** confirmar se o Dr. Charlington prefere utilizar as Figuras 2–3 diretamente ou adaptadas no design system da apresentação.
